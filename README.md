...
<video src="https://github.com/xOAviOx/gantry/raw/main/docs/demo.mp4" controls muted width="100%"></video>

▶ **[Watch the demo](https://github.com/xOAviOx/gantry/raw/main/docs/demo.mp4)** (if the player doesn't load inline)
